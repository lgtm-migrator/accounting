...
class TransactionNew extends React.Component {
  ...
  onSubmit(event) {
    ...
    Axios.post(config.apiUrl("/verification/create-transaction"), formData, {
...
class Transaction extends React.Component {
  ...
  listenForTab(event) {
    if (event.key === "Tab") {
      if (
        typeof this.props.appendTransaction !== "undefined" &&
        this.props.appendTransaction !== null
      ) {
  ...
  updateParent() {
    const account =
      this.state.account !== null ? parseInt(this.state.account.value) : null;
