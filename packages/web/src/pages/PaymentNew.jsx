          ...
          <div className="info">
            <div>
              <span className="label">
                {this.state.type === PAYMENT_DIRECT_OUT ? "Payed" : "Invoice"}{" "}
                amount
              </span>
              <input
                type="text"
            ...
            <div
              className={
                this.state.input.currency ===
                  localStorage.getItem("localCurrencyCode") ||
            ...
            <div
              className={
                this.state.input.type === INVOICE_IN_PAYMENT ? "hidden" : ""
              }
            >
            ...
            <div
              className={this.state.input.type === INVOICE_IN ? "hidden" : ""}
            >
