...
export class ApiAppAdapter implements ApiAdapter {
  ...
  verification = {
    async getAll(
      input: VerificationGetAllInput
    ): Promise<ApiVerificationGetAllOutput> {
    ...
    ): Promise<ApiVerificationAddCustomOutput> {
    ...
    ): Promise<ApiVerificationAddFromParserOutput> {
  ...
  fiscalYear = {
    async getAll(
      input: FiscalYearGetAllInput
    ): Promise<ApiFiscalYearGetAllOutput> {
