...
export class InteractorAppAdapter implements InteractorAdapter {
  verification = {
    ...
    newFromParser: new VerificationNewFromParserInteractor(
      new VerificationNewFromParserRepositoryAdapter()
    ),
    new: new VerificationNewInteractor(new VerificationNewRepositoryAdapter()),
    save: new VerificationSaveInteractor(
      new VerificationSaveRepositoryAdapter()
    ),
    getAll: new VerificationGetAllInteractor(
      new VerificationGetAllRepositoryAdapter()
    ),
  }
  ...
  fiscalYear = {
    getAll: new FiscalYearGetAllInteractor(
      new FiscalYearGetAllRepositoryAdapter()
    ),
  }
}
