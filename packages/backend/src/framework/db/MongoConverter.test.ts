...
describe('MongoConverter #cold #helper', () => {
  ...
  it('Regexp converter', () => {
    ...
    expect(
      MongoConverter.toOption(MongoConverter.toDbObject(entity))
  ...
  it('toVerification() Full verification', () => {
    ...
    // Test back and forth
    expect(
      MongoConverter.toVerification(MongoConverter.toDbObject(entity))
    ).toStrictEqual(valid)
  })
  ...
  it('Account converter', () => {
    ...
    expect(
      MongoConverter.toAccount(MongoConverter.toDbObject(account))
  ...
  it('Single parser converter', () => {
    ...
    expect(
      MongoConverter.toParser(MongoConverter.toDbObject(parser))
    ).toStrictEqual(parser)
  })
  ...
  it('toFiscalYear()', () => {
    ...
    expect(
      MongoConverter.toFiscalYear(MongoConverter.toDbObject(fiscalYear))
    ).toStrictEqual(fiscalYear)
  })
})
