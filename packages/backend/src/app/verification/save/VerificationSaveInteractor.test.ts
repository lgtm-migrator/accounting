...
describe('Save Verification #cold #use-case', () => {
  ...
  beforeEach(() => {
    repository = {
      ...
      async saveVerification(
        ...
        const savedVerification = new Verification(verification)
      ...
      async saveFiles(verification: Verification): Promise<Verification> {
        const updated = new Verification(verification)
  ...
  it('Duplicate verification', async () => {
    ...
    repository.getExistingVerification = function (
      verification: Verification.Comparable
    ): Promise<Verification> {
  ...
  it('Existing verification with files, try to add the same files', async () => {
    ...
    repository.getExistingVerification = async function (
      verification: Verification.Comparable
    ): Promise<Verification> {
