...
describe('Currency compare tests #cold #entity', () => {
  ...
  it('isComparableTo() -> Minimum data', () => {
    ...
    const second = new Currency(data)
  ...
  it('isCodeEqualTo() check true equality for codes', () => {
    ...
    expect(Currency.isCodeEqualTo(undefined, Currency.Codes.SEK)).toStrictEqual(
      false
    )
    expect(Currency.isCodeEqualTo(Currency.Codes.SEK, undefined)).toStrictEqual(
      false
    )
    ...
    // Code against Code
    expect(
      Currency.isCodeEqualTo(Currency.Codes.SEK, Currency.Codes.SEK)
    ).toStrictEqual(true)
    expect(
      Currency.isCodeEqualTo(Currency.Codes.SEK, Currency.Codes.USD)
    ).toStrictEqual(false)
    expect(
      Currency.isCodeEqualTo(Currency.Codes.USD, Currency.Codes.SEK)
    ).toStrictEqual(false)

    // Code against string
    expect(Currency.isCodeEqualTo(Currency.Codes.SEK, 'SEK')).toStrictEqual(
      true
    )
    expect(Currency.isCodeEqualTo('SEK', Currency.Codes.SEK)).toStrictEqual(
      true
    )
    expect(Currency.isCodeEqualTo('USD', Currency.Codes.SEK)).toStrictEqual(
      false
    )
    expect(Currency.isCodeEqualTo(Currency.Codes.SEK, 'USD')).toStrictEqual(
      false
    )
  })
